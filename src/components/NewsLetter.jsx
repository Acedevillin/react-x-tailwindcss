        ...
        <div className='w-full py-16 text-white px-4'>
            <div className='max-w-[1280px] mx-auto grid lg:grid-cols-3'>
                <div className='lg:col-span-2 my-4'>
                    ...
                    <p>Sign up our newletter and stay up to date.</p>
                </div>
                <div className='my-4'>
                    <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                        <input className='p-3 flex w-full rounded-md text-black' type="email" placeholder='Enter Email' />
                        <button className='bg-[#00df9a] text-black w-[200px] rounded-md font-medium ml-4 my-6 py-3 px-6'>Notify Me</button>
                    </div>
